        ...
        public IActionResult Home(){
            ...
            if(userID != null){
                ...
                if(dbUser != null){
                    ...
                    List<Users> highUsers = _context.users
                    .OrderByDescending(user => user.points).ToList();
                    ViewBag.allUsers = highUsers;

                    List<UserCategory> likedCategories = _context.usersCategory
                    .Where(uc => uc.User == dbUser)
                    .Include(uc => uc.User)
                    .Include(uc => uc.Category)
                    .ToList();
                    ViewBag.likedCategory = likedCategories;

                    List<Categories> allCategories = _context.categories
                    .ToList();
